      ...
      <header class="c-article-header">
        <div>
          <div class="c-meta-pill"> 
            ...
            ?>
            <div class="c-read-time"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM13 12V7H11V14H17V12H13Z"></path></svg><?php echo do_shortcode('[maw_reading_time]'); ?>  </div>
          </div>
      ...
      <article <?php post_class('alignwide'); ?> role="article">
        ...
        <div class="c-post-footer">
          ...
          <div class="c-social-share">
              ...
              <div>
                <a  class="c-return-link" href="/blog">View all posts</a>
